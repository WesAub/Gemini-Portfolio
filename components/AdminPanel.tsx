    ...
    <div className="max-w-xl mx-auto mt-20 p-8 bg-white border border-gray-200 shadow-xl relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="w-full bg-gray-50 border-b border-gray-300 p-3"
              required
            >
        ...
        <div className="relative">
          <div className="flex justify-between items-end mb-2">
            ...
            <button
              ...
              disabled={aiLoading}
              className="text-xs font-bold flex items-center gap-1 text-swiss-red"
            >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-black text-white py-4 font-bold uppercase tracking-widest hover:bg-swiss-red transition-colors"
        >
          {loading ? 'Syncing...' : 'Sync to RDS'}
        </button>
      </form>
    </div>
  );
